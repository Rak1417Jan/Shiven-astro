...
export function AstrologerCard({
  ...
  compact?: boolean;
  /** e.g. "/customer" for customer panel links */
  basePath?: string;
}) {
  return (
        ...
        <div className={cn("flex gap-4", compact && "flex-1")}>
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 flex items-center gap-2">
              <StarRating rating={astrologer.rating} className="shrink-0" />
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <Link href={`${basePath}/astrologers/${astrologer.slug}`}>
                <Button size="sm" variant="outline">View Profile</Button>
              </Link>
              <Link href={`${basePath}/book/${astrologer.id}`}>
